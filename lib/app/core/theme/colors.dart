...
class LocalColors {
  ...
  static const BACKGROUND_Light = Color(0xFFF3F5F7);
  static const BACKGROUND_BLUE = Color(0xFFF4FAFF);
  static const BACKGROUND_Dark = Color(0xff121212);
  static const TEXT_ABC_GREEN = Color(0xFF267F00);
  ...
  static const bg_white = Color(0xfffffffff);
  ...
  static const bg_success_light = Color(0xffe8fff3);
